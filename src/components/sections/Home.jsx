...
export const Home = ({ isLoaded }) => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative bg-[#060A14]">
      {/* Gradient Background */}
      <div className={`absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/3 w-screen h-screen gradient-background transition-all duration-1000 ease-out pointer-events-none
          ${isLoaded ? "opacity-100 scale-100 blur-[150px] gradient-float" : "opacity-0 scale-75 blur-[250px]"}
        `}></div>
