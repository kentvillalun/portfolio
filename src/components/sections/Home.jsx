...
export const Home = () => {
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/3 w-screen h-screen gradient-background"></div>
      <div className="z-10 text-center flex flex-col gap-9.25 mx-auto">
        ...
        <p className="mx-4 max-w-136.75 text-md md:text-lg transition-all text-gray-400">
            3rd year BS Information Technology student passionate about building web experiences.
        </p>
        ...
        <div className="flex flex-row justify-center gap-5">
            <a href="https://github.com/kentvillalun" target="_blank" className="p-3.5 bg-[#0D2D5C] rounded-lg transition-transform hover:scale-110 hover:shadow-lg">
                <GithubIcon />
            </a>
            <a href="https://www.linkedin.com/in/kent-villalun-849b25366" target="_blank" className="p-3.5 rounded-lg bg-[#0A66C2] transition-transform hover:scale-110 hover:shadow-lg " >
                <LinkedinIcon />
            </a>
            <a href="#contact" className="p-3.5 rounded-lg bg-linear-to-b from-[#437BFF] to-[#A251FF] transition-transform hover:scale-110 hover:shadow-lg">
                <MailIcon />
            </a>
        </div>
      </div>
