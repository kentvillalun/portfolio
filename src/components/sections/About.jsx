      ...
      <div className="mx-auto px-6 max-w-3xl md:max-w-5xl">
        ...
        <div className="rounded-3xl  md:p-10 md:border-white/10 md:hover:-translate-y-1 transition-transform duration-500 ease-out transform-gpu md:border md:bg-[#00000025] w-full md:mx-0 flex flex-col md:flex-row items-center md:items-start justify-between gap-6 md:gap-10">
          <div className="w-full md:w-[40%]">
            <img
              src="../src/assets/images/about-pic-png"
          ...
          <div className="flex flex-col gap-3 text-[18px] flex-1">
            <p className="">
              Hi! I’m <span className="text-white font-semibold">Kent</span>, a
              3rd year BS Information Technology student from{" "}
              <span className="text-white font-semibold">Ilocos</span>. I serve
              as the{" "}
            ...
            <p className="">
              I believe{" "}
              <span className="text-white font-semibold">great design</span> and{" "}
              <span className="text-white font-semibold">clean code</span> go
              hand in hand, and I’m excited to grow my skills through every
              project I build.
            </p>
          </div>
        </div>
